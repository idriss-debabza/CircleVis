...
OverlapText.prototype.GetBorders = function (texts) {
    ...
    //    bboxtext.height = text.getBoundingClientRect().height;
      //  console.log(' hi ' ,text, text.getComputedTextLength(),text.getBoundingClientRect() );
...
OverlapText.prototype.TestOverlapPFS = function (texts){
   ...
   // console.log ('les centres ',texts , textsCenters); 
    ...
    while ((index < textAres.length) ){
        ...
        while ((index2 < textAres.length) ) {
            ...
            if (index != index2) {
             ...
             //  console.log('emchi te3ti ', w,distx,'dhorka l h w l y ', h, disty, cond );
              // console.log('emchi te3ti 1 ' , cond, texts[index], texts[index2]);
               //console.log('emchi te3ti 2 ' , textAres[index], textAres[index2]);
            }
            index2++;
    ...
    console.log ( 'emchi t3tiiiiii ', cond);
    return cond;
}/*
